...
class CrearMensajePage extends StatefulWidget {
  @override
  _CrearMensajePageState createState() => _CrearMensajePageState();
}

class _CrearMensajePageState extends State<CrearMensajePage> {
  ...
  Widget _crearNombre() {
    return Container(
        child: Text('Receiver: ${_prefs.destinatarioNombre.toString()}'));
  }
  ...
  void _submit() async {
    ...
    mensaje.destinatario = _prefs.destinatario.toString();
