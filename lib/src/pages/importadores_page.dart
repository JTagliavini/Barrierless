...
class ImportadoresPage extends StatefulWidget {
  @override
  _ImportadoresPageState createState() => _ImportadoresPageState();

  static const TextStyle optionStyle =
      TextStyle(fontSize: 30, fontWeight: FontWeight.bold);
}

class _ImportadoresPageState extends State<ImportadoresPage> {
  @override
...
//          leading: Icon(Icons.tag_faces),
  ...
  void _onItemTapped(int index) {
    if (index == 0) Navigator.pushReplacementNamed(context, 'exportadores');
      ...
      builder:
        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, i) => (empresas[i].importador)
