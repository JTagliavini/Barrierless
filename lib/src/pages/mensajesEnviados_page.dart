...
class MensajesEnviadosPage extends StatefulWidget {
  @override
  _MensajesEnviadosPageState createState() => _MensajesEnviadosPageState();

  static const TextStyle optionStyle =
      TextStyle(fontSize: 30, fontWeight: FontWeight.bold);
}

class _MensajesEnviadosPageState extends State<MensajesEnviadosPage> {
  ...
  void _onItemTapped(int index) {
    if (index == 0)
      Navigator.pushReplacementNamed(context, 'mensajesRecibidos');
        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, i) =>
                (mensajes[i].remitente == _prefs.email.toString())
